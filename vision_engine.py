...
class VisionEngine:
    def __init__(self):
        print("[INFO] Loading Florence-2 Vision Engine...")
        ...
        print("[INFO] Vision Engine Ready.")

    def analyze_scene(self, image: Image.Image) -> str:
        """Runs a two-stage vision query and merges the results."""
        start_time = time.time()
        
        # ==========================================
        # QUERY 1: LOCATION & BASE DETECTION
        # ==========================================
        ...
        # Build the spatial list using the helper function below
        spatial_graph = self._build_scene_graph(labels, bboxes, image.size)

        # ==========================================
        # QUERY 2: DEEP PHYSICAL PROPERTIES
        # ==========================================
        task_2 = "<VQA>"
...
{physical_details}
        ...
        return merged_scene_context

    # --- MISSING HELPER FUNCTION ADDED BACK HERE ---
    def _build_scene_graph(self, labels, bboxes, image_size):
        """Adds spatial context (Left/Center/Right) to the detected objects."""
        if not labels:
